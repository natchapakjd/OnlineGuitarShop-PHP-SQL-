...
function getOrderItems($orderId)
{
    ...
    $sql = "SELECT order_items.ord_id , product.p_name, order_items.quantity ,product.p_image_path FROM order_items
                                ...
                                <table id="example1" class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php foreach ($orderItems as $item) : ?>
                                            <tr>
                                                <td><img style="max-width: 100px;" src=" <?php echo $item['p_image_path'];  ?>" alt="p_img"></td>
